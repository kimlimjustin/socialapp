...
const EditPost = (params) => {
    ...
    const Submit = (e) => {
        ...
        Axios.post(`http://localhost:5000/posts/update/${params.match.params.id}`, Post)
        ...
        <div className="container">
            ...
            ?<form className = "margin box box-shadow" onSubmit = {Submit} key={postInfo.description}>
                ...
                <div className="form-group">
                    <img src ={`http://localhost:5000/${postInfo.image.filename}`} alt={postInfo.description} className="box-image" />
                </div>
                <div className = "form-group">
